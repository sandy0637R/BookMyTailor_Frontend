...
const ClothEdit = ({ cloth, onCancel }) => {
  ...
  return (
    <form onSubmit={handleEditSubmit} className="grid gap-2">
      <input name="type" value={editFormData.type} onChange={handleChange} placeholder="Type" required className="border p-2 rounded" />
      <input name="price" type="number" value={editFormData.price} onChange={handleChange} placeholder="Price" required className="border p-2 rounded" />
      <input name="size" value={editFormData.size.join(",")} onChange={handleChange} placeholder="Sizes" className="border p-2 rounded" />
      <select name="gender" value={editFormData.gender} onChange={handleChange} className="border p-2 rounded">
      ...
      <textarea name="description" value={editFormData.description} onChange={handleChange} placeholder="Description" className="border p-2 rounded" />
