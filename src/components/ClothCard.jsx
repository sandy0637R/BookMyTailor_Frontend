  ...
  return (
    <div className="bg-white rounded shadow-md p-4">
      ...
      <div className="mt-4 flex gap-2">
        <button onClick={() => onEdit(cloth)} className="bg-yellow-500 text-white px-3 py-1 rounded">Edit</button>
        <button onClick={() => onDelete(cloth._id)} className="bg-red-500 text-white px-3 py-1 rounded">Delete</button>
      </div>
    </div>
  );
};
